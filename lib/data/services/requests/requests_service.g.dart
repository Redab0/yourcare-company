...
class _RequestsService implements RequestsService {
  ...
  Future<ApiResponse<ResponsePayload<PaginatedData<CleaningRequest>>>>
      getAvailableRequests(int page, int limit) async {
  ...
  @override
  Future<ApiResponse<ResponsePayload<PaginatedData<CleaningRequest>>>>
      getReorders(int page, int limit) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ApiResponse<ResponsePayload<BusinessOfferResponse>>> submitOffer(
    ...
    final _options =
        _setStreamType<ApiResponse<ResponsePayload<BusinessOfferResponse>>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/requests/deep-cleaning/business-offer',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<ResponsePayload<BusinessOfferResponse>> _value;
    try {
      _value = ApiResponse<ResponsePayload<BusinessOfferResponse>>.fromJson(
        _result.data!,
        (json) => ResponsePayload<BusinessOfferResponse>.fromJson(
          json as Map<String, dynamic>,
          (json) =>
              BusinessOfferResponse.fromJson(json as Map<String, dynamic>),
        ),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  Future<ApiResponse<ResponsePayload<BusinessOfferResponse>>>
      submitUpholsteryOffer(BusinessOffer body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _options =
      ...
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/requests/upholstery-cleaning/business-offer',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
  ...
  Future<ApiResponse<ResponsePayload<CleaningRequest>>>
    ...
    final _options =
      ...
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/requests/${id}/house-cleaning/accept',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
